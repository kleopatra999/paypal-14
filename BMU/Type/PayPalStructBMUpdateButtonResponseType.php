<?php
/**
 * File for class PayPalStructBMUpdateButtonResponseType
 * @package PayPal
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for PayPalStructBMUpdateButtonResponseType originally named BMUpdateButtonResponseType
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class PayPalStructBMUpdateButtonResponseType extends PayPalStructAbstractResponseType
{
	/**
	 * The Website
	 * Meta informations extracted from the WSDL
