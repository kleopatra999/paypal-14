<?php
/**
 * File for class PayPalServiceEnter
 * @package PayPal
 * @subpackage Services
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for PayPalServiceEnter originally named Enter
 * @package PayPal
 * @subpackage Services
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
...
class PayPalServiceEnter extends PayPalWsdlClass
{
	 ...
	 * @uses PayPalStructEnterBoardingReq::getEnterBoardingRequest()
	 * @param PayPalStructEnterBoardingReq $_payPalStructEnterBoardingReq
	 * @return PayPalStructEnterBoardingResponseType
	 */
	public function EnterBoarding(PayPalStructEnterBoardingReq $_payPalStructEnterBoardingReq)
	{
		try
		{
			$this->setResult(self::getSoapClient()->EnterBoarding(array('EnterBoardingRequest'=>$_payPalStructEnterBoardingReq->getEnterBoardingRequest())));
		}
