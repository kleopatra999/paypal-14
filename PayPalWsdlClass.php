<?php
/**
 * File for PayPalWsdlClass to communicate with SOAP service
 * @package PayPal
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
/**
 * PayPalWsdlClass to communicate with SOAP service
 * 
 * @package PayPal
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class PayPalWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses PayPalWsdlClass::setLastError()
	 * @uses PayPalWsdlClass::initSoapClient()
	 * @uses PayPalWsdlClass::initInternArrayToIterate()
	 * @uses PayPalWsdlClass::_set()
	...
	public static function __set_state(array $_array,$_className = __CLASS__)
	{
		if(class_exists($_className))
		{
			...
			if(is_object($object) && is_subclass_of($object,'PayPalWsdlClass'))
			{
	 ...
	 * @uses PayPalClassMap::classMap()
	 * @uses PayPalWsdlClass::getDefaultWsdlOptions()
	 * @uses PayPalWsdlClass::setSoapClient()
	 * @param array $_wsdlOptions WSDL options
	 * @return void
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('PayPalClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = PayPalClassMap::classMap();
	 ...
	 * @uses PayPalWsdlClass::WSDL_CACHE_WSDL
	 * @uses PayPalWsdlClass::WSDL_COMPRESSION
	 * @uses PayPalWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses PayPalWsdlClass::WSDL_ENCODING
	 * @uses PayPalWsdlClass::WSDL_EXCPTS
	 * @uses PayPalWsdlClass::WSDL_FEATURES
	 * @uses PayPalWsdlClass::WSDL_LOGIN
	 * @uses PayPalWsdlClass::WSDL_PASSWD
	 * @uses PayPalWsdlClass::WSDL_SOAP_VERSION
	 * @uses PayPalWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses PayPalWsdlClass::WSDL_TRACE
	 * @uses PayPalWsdlClass::WSDL_TYPEMAP
	 * @uses PayPalWsdlClass::WSDL_URL
	 * @uses PayPalWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses PayPalWsdlClass::getSoapClient()
	 * @uses PayPalWsdlClass::getFormatedXml()
	 ...
	 * @uses PayPalWsdlClass::getSoapClient()
	 * @uses PayPalWsdlClass::convertStringHeadersToArray()
	 ...
	 * @uses PayPalWsdlClass::getInternArrayToIterate()
	 * @uses PayPalWsdlClass::getInternArrayToIterateIsArray()
	 * @return int
	 */
	 ...
	 * @uses PayPalWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses PayPalWsdlClass::getInternArrayToIterateOffset()
	 * @uses PayPalWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses PayPalWsdlClass::getInternArrayToIterateOffset()
	 * @uses PayPalWsdlClass::offsetExists()
	 * @return bool true|false
	 */
	 ...
	 * @uses PayPalWsdlClass::getAttributeName()
	 * @uses PayPalWsdlClass::__toString()
	 * @uses PayPalWsdlClass::_set()
	 * @uses PayPalWsdlClass::_get()
	 * @uses PayPalWsdlClass::setInternArrayToIterate()
	 * @uses PayPalWsdlClass::setInternArrayToIterateIsArray()
	 * @uses PayPalWsdlClass::setInternArrayToIterateOffset()
