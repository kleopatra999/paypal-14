<?php
/**
 * File for class PayPalStructSetMobileCheckoutResponseType
 * @package PayPal
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for PayPalStructSetMobileCheckoutResponseType originally named SetMobileCheckoutResponseType
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class PayPalStructSetMobileCheckoutResponseType extends PayPalStructAbstractResponseType
{
	/**
	 * The Token
	 * Meta informations extracted from the WSDL
