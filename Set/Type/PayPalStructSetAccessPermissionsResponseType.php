<?php
/**
 * File for class PayPalStructSetAccessPermissionsResponseType
 * @package PayPal
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for PayPalStructSetAccessPermissionsResponseType originally named SetAccessPermissionsResponseType
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class PayPalStructSetAccessPermissionsResponseType extends PayPalStructAbstractResponseType
{
	/**
	 * The Token
	 * Meta informations extracted from the WSDL
