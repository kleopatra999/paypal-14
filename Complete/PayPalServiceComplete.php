<?php
/**
 * File for class PayPalServiceComplete
 * @package PayPal
 * @subpackage Services
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for PayPalServiceComplete originally named Complete
 * @package PayPal
 * @subpackage Services
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
...
class PayPalServiceComplete extends PayPalWsdlClass
{
	 ...
	 * @uses PayPalStructCompleteRecoupReq::getCompleteRecoupRequest()
	 * @param PayPalStructCompleteRecoupReq $_payPalStructCompleteRecoupReq
	 * @return PayPalStructCompleteRecoupResponseType
	 */
	public function CompleteRecoup(PayPalStructCompleteRecoupReq $_payPalStructCompleteRecoupReq)
	{
		try
		{
			$this->setResult(self::getSoapClient()->CompleteRecoup(array('CompleteRecoupRequest'=>$_payPalStructCompleteRecoupReq->getCompleteRecoupRequest())));
		}
