<?php
/**
 * File for class PayPalStructGetAccessPermissionDetailsRequestType
 * @package PayPal
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for PayPalStructGetAccessPermissionDetailsRequestType originally named GetAccessPermissionDetailsRequestType
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class PayPalStructGetAccessPermissionDetailsRequestType extends PayPalStructAbstractRequestType
{
	/**
	 * The Token
	 * Meta informations extracted from the WSDL
