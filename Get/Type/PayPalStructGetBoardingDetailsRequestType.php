<?php
/**
 * File for class PayPalStructGetBoardingDetailsRequestType
 * @package PayPal
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for PayPalStructGetBoardingDetailsRequestType originally named GetBoardingDetailsRequestType
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class PayPalStructGetBoardingDetailsRequestType extends PayPalStructAbstractRequestType
{
	/**
	 * The Token
	 * Meta informations extracted from the WSDL
