<?php
/**
 * File for class PayPalStructGetExpressCheckoutDetailsRequestType
 * @package PayPal
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for PayPalStructGetExpressCheckoutDetailsRequestType originally named GetExpressCheckoutDetailsRequestType
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class PayPalStructGetExpressCheckoutDetailsRequestType extends PayPalStructAbstractRequestType
{
	/**
	 * The Token
	 * Meta informations extracted from the WSDL
