<?php
/**
 * File for class PayPalStructDoMobileCheckoutPaymentRequestType
 * @package PayPal
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for PayPalStructDoMobileCheckoutPaymentRequestType originally named DoMobileCheckoutPaymentRequestType
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class PayPalStructDoMobileCheckoutPaymentRequestType extends PayPalStructAbstractRequestType
{
	/**
	 * The Token
	 * Meta informations extracted from the WSDL
