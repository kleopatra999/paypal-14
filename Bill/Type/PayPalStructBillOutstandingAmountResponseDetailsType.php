<?php
/**
 * File for class PayPalStructBillOutstandingAmountResponseDetailsType
 * @package PayPal
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for PayPalStructBillOutstandingAmountResponseDetailsType originally named BillOutstandingAmountResponseDetailsType
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class PayPalStructBillOutstandingAmountResponseDetailsType extends PayPalWsdlClass
{
	/**
	 * The ProfileID
	 * Meta informations extracted from the WSDL
