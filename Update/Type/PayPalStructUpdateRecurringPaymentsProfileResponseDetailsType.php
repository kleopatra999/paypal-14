<?php
/**
 * File for class PayPalStructUpdateRecurringPaymentsProfileResponseDetailsType
 * @package PayPal
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for PayPalStructUpdateRecurringPaymentsProfileResponseDetailsType originally named UpdateRecurringPaymentsProfileResponseDetailsType
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class PayPalStructUpdateRecurringPaymentsProfileResponseDetailsType extends PayPalWsdlClass
{
	/**
	 * The ProfileID
	 * Meta informations extracted from the WSDL
