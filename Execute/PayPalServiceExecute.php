<?php
/**
 * File for class PayPalServiceExecute
 * @package PayPal
 * @subpackage Services
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for PayPalServiceExecute originally named Execute
 * @package PayPal
 * @subpackage Services
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
...
class PayPalServiceExecute extends PayPalWsdlClass
{
	 ...
	 * @uses PayPalStructExecuteCheckoutOperationsReq::getExecuteCheckoutOperationsRequest()
	 * @param PayPalStructExecuteCheckoutOperationsReq $_payPalStructExecuteCheckoutOperationsReq
	 * @return PayPalStructExecuteCheckoutOperationsResponseType
	 */
	public function ExecuteCheckoutOperations(PayPalStructExecuteCheckoutOperationsReq $_payPalStructExecuteCheckoutOperationsReq)
	{
		try
		{
			$this->setResult(self::getSoapClient()->ExecuteCheckoutOperations(array('ExecuteCheckoutOperationsRequest'=>$_payPalStructExecuteCheckoutOperationsReq->getExecuteCheckoutOperationsRequest())));
		}
