<?php
/**
 * File for class PayPalServiceBMB
 * @package PayPal
 * @subpackage Services
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for PayPalServiceBMB originally named BMB
 * @package PayPal
 * @subpackage Services
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
...
class PayPalServiceBMB extends PayPalWsdlClass
{
	 ...
	 * @uses PayPalStructBMButtonSearchReq::getBMButtonSearchRequest()
	 * @param PayPalStructBMButtonSearchReq $_payPalStructBMButtonSearchReq
	 * @return PayPalStructBMButtonSearchResponseType
	 */
	public function BMButtonSearch(PayPalStructBMButtonSearchReq $_payPalStructBMButtonSearchReq)
	{
		try
		{
			$this->setResult(self::getSoapClient()->BMButtonSearch(array('BMButtonSearchRequest'=>$_payPalStructBMButtonSearchReq->getBMButtonSearchRequest())));
		}
