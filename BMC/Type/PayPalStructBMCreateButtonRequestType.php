<?php
/**
 * File for class PayPalStructBMCreateButtonRequestType
 * @package PayPal
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for PayPalStructBMCreateButtonRequestType originally named BMCreateButtonRequestType
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class PayPalStructBMCreateButtonRequestType extends PayPalStructAbstractRequestType
{
	/**
	 * The ButtonType
	 * Meta informations extracted from the WSDL
	 ...
	 */
	public function __construct($_buttonType = NULL,$_buttonCode = NULL,$_buttonSubType = NULL,$_buttonVar = NULL,$_optionDetails = NULL,$_textBox = NULL,$_buttonImage = NULL,$_buttonImageURL = NULL,$_buyNowText = NULL,$_subscribeText = NULL,$_buttonCountry = NULL,$_buttonLanguage = NULL)
	{
		PayPalWsdlClass::__construct(array('ButtonType'=>$_buttonType,'ButtonCode'=>$_buttonCode,'ButtonSubType'=>$_buttonSubType,'ButtonVar'=>$_buttonVar,'OptionDetails'=>$_optionDetails,'TextBox'=>$_textBox,'ButtonImage'=>$_buttonImage,'ButtonImageURL'=>$_buttonImageURL,'BuyNowText'=>$_buyNowText,'SubscribeText'=>$_subscribeText,'ButtonCountry'=>$_buttonCountry,'ButtonLanguage'=>$_buttonLanguage));
	}
	/**
