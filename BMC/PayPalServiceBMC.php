<?php
/**
 * File for class PayPalServiceBMC
 * @package PayPal
 * @subpackage Services
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for PayPalServiceBMC originally named BMC
 * @package PayPal
 * @subpackage Services
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
...
class PayPalServiceBMC extends PayPalWsdlClass
{
	 ...
	 * @uses PayPalStructBMCreateButtonReq::getBMCreateButtonRequest()
	 * @param PayPalStructBMCreateButtonReq $_payPalStructBMCreateButtonReq
	 * @return PayPalStructBMCreateButtonResponseType
	 */
	public function BMCreateButton(PayPalStructBMCreateButtonReq $_payPalStructBMCreateButtonReq)
	{
		try
		{
			$this->setResult(self::getSoapClient()->BMCreateButton(array('BMCreateButtonRequest'=>$_payPalStructBMCreateButtonReq->getBMCreateButtonRequest())));
		}
